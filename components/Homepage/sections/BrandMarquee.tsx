...
import { Draggable, gsap, useGSAP } from "@/lib/gsap/register";
  ...
  return (
    <section ref={rootRef} className="px-6 py-24 md:px-10">
      <div className="mx-auto max-w-400">
        <h2
          ref={titleRef}
          className="max-w-150 text-display leading-[0.9] font-extrabold tracking-tighter text-gh-black"
        >
      ...
      <div
        ref={rowRef}
        className="relative right-1/2 left-1/2 -mx-[50vw] mt-10 w-screen overflow-hidden py-7"
      >
        <div
          ref={viewportRef}
